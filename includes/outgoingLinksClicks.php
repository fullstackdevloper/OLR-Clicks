...
$getResult = get_distinct_outgoing_link_clicks_from_db();	
?>
<h2>Track of Outgoing links </h2>
<div id="outgoing_links">
    <button class="export_button">
        <a href="#" id="outgoingLinksClicks">Export Data Into Excel</a>
    </button>
